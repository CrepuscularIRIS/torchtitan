...
class PolicyTrainer(Actor, Configurable):
    ...
    class Config(Configurable.Config):
        ...
        """DType to cast weights to before transfer to generator.
        If None or same as training dtype, no cast is performed."""
        dump_folder: str = ""
    ...
    def __init__(
        ...
        *,
        ...
        requested = (
            TORCH_DTYPE_MAP[config.transfer_dtype]
            if config.transfer_dtype is not None
            else None
        )
